    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white">AppCraft</h1>
          <p className="text-slate-400 text-sm mt-1">by DigitalSpot</p>
        </div>
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/15 bg-white/5 text-white text-sm font-semibold hover:bg-white/10 transition-colors mb-4 disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <p className="text-center text-xs text-slate-500 mt-5">
            ...
            <Link href="/auth/signup" className="text-indigo-400 font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
        ...
        <p className="text-center text-[10px] text-slate-600 mt-4">
          © 2024 DigitalSpot Agency · All rights reserved
        </p>
      </motion.div>
    </div>
  );
